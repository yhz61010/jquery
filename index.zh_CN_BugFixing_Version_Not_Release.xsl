...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	<xsl:output method="html" indent="yes" version="5.0" encoding="utf8" />
	...
	<xsl:template match="/">
		...
		<body id="api">
			<div id="header">
				<div id="headerMain"><h1>jQuery 中文文档 Translated by <a href="http://www.ho1ho.com/">Michael Leo</a>, Thanks <a href="http://www.cn-cuckoo.com/">为之漫笔</a> for original version.</h1></div>
			</div>
			<div id="wrapper">
				<div id="sidebar">
